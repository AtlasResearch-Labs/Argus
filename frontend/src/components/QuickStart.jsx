      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-12">
          ...
          <p className="text-neutral-400 text-xs sm:text-sm font-mono mt-2">
            Argus runs as a standard GitHub Action. No third-party OAuth app permissions or broad repository read access required.
          </p>
        </div>

        {/* 3 Step Workflow */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10 font-mono text-xs">
          <div className="p-6 rounded-sm bg-[#050505] border border-[#1a1a1a]">
            ...
            <p className="text-neutral-400 font-sans text-xs">
              Add <code className="text-neutral-200 bg-[#141414] px-1 py-0.5 rounded-sm">.github/workflows/argus.yml</code> to your repository root.
            </p>
          </div>
          ...
          <div className="p-6 rounded-sm bg-[#050505] border border-[#1a1a1a]">
            ...
            <p className="text-neutral-400 font-sans text-xs">
              Add <code className="text-neutral-200 bg-[#141414] px-1 py-0.5 rounded-sm">POWERBOX_API_KEY</code> in GitHub repository secrets. Public repos run free.
            </p>
          </div>
          ...
          <div className="p-6 rounded-sm bg-[#050505] border border-[#1a1a1a]">
            ...
            <p className="text-neutral-400 font-sans text-xs">
              Argus automatically audits the diff and posts committable suggestion blocks directly on modified lines.
            </p>
          </div>
        </div>

        {/* Copyable YAML Box */}
        <div className="rounded-sm bg-[#050505] border border-[#1a1a1a] overflow-hidden shadow-2xl font-mono">
          <div className="px-4 py-3 bg-[#0a0a0a] border-b border-[#171717] flex items-center justify-between">
            ...
            <button
              onClick={handleCopy}
              className="flex items-center gap-1.5 px-3 py-1 rounded-sm bg-[#141414] border border-[#222] hover:border-[#333] text-xs text-neutral-300 transition"
            >
